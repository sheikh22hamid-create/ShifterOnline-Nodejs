...
public class PDOrderItem implements Parcelable {
	...
	@SerializedName("plan_benefit_applied")
	private boolean planBenefitApplied;

	@SerializedName("plan_name")
	private String planName;

	@SerializedName("plan_discount_applied")
	private String planDiscountApplied;
	...
	protected PDOrderItem(Parcel in) {
		stops = in.createTypedArrayList(OrderStop.CREATOR);
	...
	public List<OrderStop> getStops() {
	...
	public boolean isPlanBenefitApplied() {
		return planBenefitApplied;
	}
	...
	public String getPlanDiscountApplied() {
		return planDiscountApplied;
	}

	public String getPlanIncentiveEarned() {
		return planIncentiveEarned;
	}
