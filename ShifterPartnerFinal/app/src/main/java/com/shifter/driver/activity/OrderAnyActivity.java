...
import com.shifter.driver.databinding.ActivityAnyOrderBinding;
import com.shifter.driver.fragment.OrderAnyFragment;

import java.util.ArrayList;
import java.util.List;

public class OrderAnyActivity extends AppCompatActivity {
    private ActivityAnyOrderBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAnyOrderBinding.inflate(getLayoutInflater());
        ...
        adapter.addFragment(OrderAnyFragment.newInstance("recent"), getString(R.string.tab_current_order));
        adapter.addFragment(OrderAnyFragment.newInstance("past"), getString(R.string.tab_completed));
    ...
    protected void onResume() {
        ...
        if (OrderAnyDetailsActivity.isUpdate) {
            OrderAnyDetailsActivity.isUpdate = false;
            recreate();
        }
    }
