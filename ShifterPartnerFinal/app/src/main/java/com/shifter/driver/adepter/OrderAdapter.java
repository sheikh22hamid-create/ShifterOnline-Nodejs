...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.MyViewHolder> {
    ...
    private final List<PDOrderItem> mCatlist;
    private final RecyclerTouchListener listener;
    SessionManager sessionManager;

    public interface RecyclerTouchListener {
        void onClickOrderItem(PDOrderItem titel, int position);
    }
    ...
    public OrderAdapter(Context mContext, List<PDOrderItem> mCatlist, final RecyclerTouchListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_rorder, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        PDOrderItem orderItem = mCatlist.get(position);
        ...
        holder.txtToaddress.setText(orderItem.getCustomerPaddress());
